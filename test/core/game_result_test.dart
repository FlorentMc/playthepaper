...
void main() {
  ...
  final where = PuzzleId.parse('where-2026-09-08-en-v1');
  ...
  group('GameResult', () {
    ...
    test('summaries read naturally', () {
      ...
      expect(GameResult(puzzleId: where, completedAt: DateTime.utc(2026), solved: true, distanceKm: 340.4).summary(),
          '340 km away');
    });
